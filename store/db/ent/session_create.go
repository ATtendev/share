...
func (sc *SessionCreate) SetDeleteAt(t time.Time) *SessionCreate {
	sc.mutation.SetDeleteAt(t)
	return sc
}

// SetNillableDeleteAt sets the "delete_at" field if the given value is not nil.
func (sc *SessionCreate) SetNillableDeleteAt(t *time.Time) *SessionCreate {
	if t != nil {
		sc.SetDeleteAt(*t)
	}
	return sc
...
func (sc *SessionCreate) SetDescription(s string) *SessionCreate {
	sc.mutation.SetDescription(s)
	return sc
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (sc *SessionCreate) SetNillableDescription(s *string) *SessionCreate {
	if s != nil {
		sc.SetDescription(*s)
	}
	return sc
...
func (sc *SessionCreate) SetPosition(s []schema.Point) *SessionCreate {
...
func (sc *SessionCreate) SetNillableIsFinished(b *bool) *SessionCreate {
	if b != nil {
		sc.SetIsFinished(*b)
	}
	return sc
...
func (sc *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.DeleteAt(); ok {
