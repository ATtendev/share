...
func (tu *TokenUpdate) ClearDeleteAt() *TokenUpdate {
...
func (tu *TokenUpdate) SetUsersID(id uuid.UUID) *TokenUpdate {
...
func (tu *TokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.DeleteAtCleared() {
		_spec.ClearField(token.FieldDeleteAt, field.TypeTime)
	}
...
// ClearDeleteAt clears the value of the "delete_at" field.
func (tuo *TokenUpdateOne) ClearDeleteAt() *TokenUpdateOne {
...
// SetUsersID sets the "users" edge to the User entity by ID.
func (tuo *TokenUpdateOne) SetUsersID(id uuid.UUID) *TokenUpdateOne {
